...
class NovelReadRepository @Inject constructor(
    ...
    suspend fun saveBookRecord(
        ...
        try {
            ...
            if (!md5.isNullOrBlank()) {
                ...
                emit("Successfully saved reading record")
                onSuccess("Successfully saved reading record")
            } else {
                onError("Error calculating md5 code")
            }
        } catch (e: Exception) {
            onError(e.toString())
        }
    ...
    suspend fun getChapterContents(
        ...
        try {
            ...
            emit(newChapters)
            onSuccess("Successfully requested chapter content")
        } catch (e: Exception) {
            onError(e.toString())
        }
    }.flowOn(Dispatchers.IO)
    ...
    suspend fun getChapterBeans(
        ...
        try {
            ...
            onSuccess("Successfully obtained the chapter list")
        } catch (e: Exception) {
            onError(e.toString())
        }
    }.flowOn(Dispatchers.IO)
    ...
    suspend fun getBookRecord(
        ...
        try {
            ...
            if (!md5.isNullOrBlank()) {
                ...
                emit(bean!!)
                onSuccess("Successfully obtained reading records")
            }
        } catch (e: Exception) {
            onError(e.toString())
        }
    ...
    suspend fun getSigns(
        ...
        try {
            ...
            onSuccess("Successfully obtained bookmark list")
        } catch (e: Exception) {
            onError(e.toString())
        }
    }.flowOn(Dispatchers.IO)
    ...
    suspend fun addSign(
        ...
        try {
            ...
            if (bookSignModel == null) {
                ...
                onError("The bookmark for this chapter already exists")
            }
        } catch (e: Exception) {
            onError(e.toString())
        }
    ...
    suspend fun deleteSign(
        ...
        try {
            ...
            emit("Successfully deleted bookmark")
            onSuccess("Successfully deleted bookmark")
        } catch (e: Exception) {
            onError(e.toString())
        }
    }.flowOn(Dispatchers.IO)
