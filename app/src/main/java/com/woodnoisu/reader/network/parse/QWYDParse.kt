...
class QWYDParse(htmlService: HtmlService):
    ...
    override val typeMap: Map<String, String> =
        mapOf("Fantasy Fantasy" to "1",
              "Wuxia Xianxia" to "2",
              "Urban officialdom" to "3",
              "Historical military" to "4",
              "Romantic time travel" to "5",
              "Paranormal suspense" to "6",
              "Game competition" to "7",
              "Youthful BL" to "8",
              "Science fiction fan" to "9",
              "Classic bestseller" to "10",
              "Books and magazines" to "11",
              "Other categories" to "0")
